...
namespace QX.OptionsBTTestApp.RD
{
    public enum TradeType
    {
        ...
        BullSquareOff,
        BearSquareOff,
        BullLadderTrade,  // Independent far leg
        BearLadderTrade,  // Independent far leg
        BullGammaBurst,
        BearGammaBurst
    }
    ...
    public class TradeRecord
    {
        ...
        // OLD: public double SpreadPnL => OptionsInfo?.Where(o => o.isSpreadLeg).Sum(o => o.CurrentPnL) ?? 0.0;
